...
(typeof window !== 'undefined' ? window : typeof self !== 'undefined' ? self : this).Genetic = require('./genetic');
...
var Genetic = Genetic || (function(){
	...
	Genetic.prototype.evolve = function(config, userData) {
		...
		// determine if we can use webworkers (patched for Web Worker context)
		var _global = typeof window !== 'undefined' ? window : typeof self !== 'undefined' ? self : {};
		this.usingWebWorker = this.configuration.webWorkers
			&& typeof Blob != "undefined"
			&& typeof Worker != "undefined"
			&& typeof _global.URL != "undefined"
			&& typeof _global.URL.createObjectURL != "undefined";
		...
		if (this.usingWebWorker) {
			...
			var worker = new Worker(_global.URL.createObjectURL(blob));
