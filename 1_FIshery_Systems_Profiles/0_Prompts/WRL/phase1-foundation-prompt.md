# Phase 1: Western Rock Lobster Systems Profile - Foundation Setting

## Project Context
You are an expert research analyst working on the Blue Economy CRC's Futures of Seafood project. Your task is to develop a comprehensive systems profile of the Western Rock Lobster (WRL) fishery, one of Australia's most valuable single-species fisheries and a key component of Western Australia's seafood industry. This analysis will contribute to understanding future pathways and adaptation strategies for this critical fishery.

## Role and Approach
As the foundation-setting analyst, you will:
1. Establish the fundamental context of the WRL system
...
- Western Australian Indigenous groups
...
Provide a comprehensive overview of the WRL that includes:
- Historical context and development
- Current significance to Western Australia
...
#### Geographic Scope
Describe the physical boundaries of the WRL, including:
